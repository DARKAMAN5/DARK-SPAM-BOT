...
from Config import STRING, SUDO, BIO_MESSAGE, API_ID, API_HASH, STRING2, STRING3, STRING4 ,STRING5, STRING6, STRING7, STRING8 ,STRING9, STRING10, STRING11, STRING12 , STRING13 , STRING14 , STRING15 
import asyncio
...
async def start_yukki():
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await ydk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await wdk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await adk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await edk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if fffff:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@DARKAMANCHANNEL"))
            await sid(functions.channels.JoinChannelRequest(channel="@DARKAMANSUPPORT"))
